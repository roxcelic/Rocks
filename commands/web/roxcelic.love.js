...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('roxcelic-love')
        .setDescription('Checks the status of my website and github information.'),
    async execute(interaction) {
        ...
        const result = await checkWebsiteStatus("https://roxcelic.love", "roxcelic", "web-home");
